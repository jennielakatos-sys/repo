...

{
  ...
  console.log({
    msg: `Do rectangles overlap? ${rectanglesOverlap(rect1, rect2)}`,
    rect1,
    rect2,
  });
  console.log({
    msg: `Is pointA inside rect1? ${rect1.contains(pointA)}`,
    rect1,
    pointA,
  });
  console.log({
    msg: `Distance between A and B: ${pointA.distance(pointB)}`,
    pointA,
    pointB,
  });
}
